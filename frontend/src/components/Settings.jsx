          ...
          <div className="bg-white border rounded-lg p-6 mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 pb-6 border-b">
                <img src="https://avatar.iran.liara.run/public/42" alt="Profile" className="w-16 h-16 rounded-full" />
                <div>
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Show alerts in browser</p>
                </div>
                <div className="relative inline-block w-12 h-6">
                  <input type="checkbox" className="peer sr-only" checked />
                  <div className="w-11 h-6 bg-gray-200 peer-checked:bg-primary-600 rounded-full"></div>
              ...
              <label className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Receive weekly analysis reports</p>
                </div>
                <div className="relative inline-block w-12 h-6">
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">Up to date</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
